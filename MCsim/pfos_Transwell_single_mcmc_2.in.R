...
Level { # top
  ...
  Simulation {
    ...
    Data(C1_blood, 0.091832198,	0.405784884,	1.228180075,	3.115489693);
    Data(C2_lumen, 0.005630539,	0.004592535,	0.052671781,	0.040707524);
    ...
    Data(C1_cell, 8427.421);		
    Data(C2_cell, 1543.469);
