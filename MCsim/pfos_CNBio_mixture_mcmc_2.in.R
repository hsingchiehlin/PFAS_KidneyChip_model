...
Level { # top
  ...
  Simulation {
    ...
    Data(C1_blood, 0.010356175,	0.221109623,	0.668153657,	0.600024047);
    Data(C2_lumen, 0.001381912,	0.003421868,	0.011741854,	0.011760163);
    ...
    Data(C1_cell, 4597.078657);		
    Data(C2_cell, 624.5268178);
