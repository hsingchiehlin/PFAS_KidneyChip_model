...
MCMC ("MCMC.default.out",      # output file
      ...
      548392764);               # random seed 1115005, 2, 1011000000, 10000001, 5437238960
...
Level { # top
  ...
  Simulation {
    ...
    Data(C1_blood, 0.051912268,	0.298332409,	1.433539448,	1.781014525);
    Data(C2_lumen, 0.003670411,	0.004700604,	0.016014599,	0.033268274);
    ...
    Data(C1_cell, 10033.72108);		
    Data(C2_cell, 1595.288699);
    #Data(A3_cell, 0.000215274);
  }
}
