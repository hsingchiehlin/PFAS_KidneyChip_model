...
MCMC ("MCMC.default.out",      # output file
      ...
      2066021067);             # random seed 1014004711, 1290171961, 657100342, 2068737417 for assumed first 2 points = 1e-15
...
Level { # top
  ...
  Simulation {
    ...
    Data(C1_blood, 0.006574918,	0.006199737,	0.417086567,	0.758076656);
    Data(C2_lumen, 0.005703597,	0.006193676,	0.078239963,	0.120257918);
    ...
    Data(C1_cell, 10.62476719);		
    Data(C2_cell, 10.01000629);
