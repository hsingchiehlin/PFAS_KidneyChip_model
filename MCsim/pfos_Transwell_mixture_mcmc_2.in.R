...
Level { # top
  ...
  Simulation {
    ...
    Data(C1_blood, 0.003411266,	0.04880032,	0.190551646,	0.577349272);
    Data(C2_lumen, 0.000320254,	0.000598597,	0.000983842,	0.001607269);
    ...
    Data(C1_cell, 3620.849825);		
    Data(C2_cell, 460.7515211);
