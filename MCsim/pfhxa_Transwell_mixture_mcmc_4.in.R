...
MCMC ("MCMC.default.out",      # output file
      ...
      2090813739);                      # random seed 4, 6699, 11010, 101023
...
Level { # top
  ...
  Simulation {
    ...
    Data(C1_blood, 0.114971904	0.2436031	0.406559551	0.766009994);
    Data(C2_lumen, 0.009065295	0.021454902	0.068846875	0.1202651);
    ...
    Data(C1_cell, 28.85802968);		
    Data(C2_cell, 18.9576419);
